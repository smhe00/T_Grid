...
> （`SELF_CERTIFIED`），状态置 `AUDIT_READY`，等待独立审计 NODE A 复审。NODEA-R4
> 修复证据见 `work/gates/GATE_5/NODEA_R4_FIX_REPORT.md`。
...
| G5 | Shadow 模式：REAL market/broker query + WOULD orders | **AUDIT_READY**（NODEA-R4 修复后） | NODEA-R4 证据 `work/gates/GATE_5/NODEA_R4_FIX_REPORT.md`；审计 `work/gates/GATE_5/NODE_A_REVIEW_ITER4_20260815.md` |
