...
class TestChainFailClosed(unittest.TestCase):
    ...
    def test_unknown_status_raises_and_blocks_new_orders(self):
        ...
        try:
            ...
            # Explicit resolution resumes execution through the engine's
            # authoritative reconciliation (RR6-001: the engine executes the
            # reconciliation itself; no fabricated result can clear SAFE_MODE).
